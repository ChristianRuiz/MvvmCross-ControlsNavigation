...
namespace Expression.Blend.SampleData.FoldersSampleDataSource
{
	using System; 
...
// the DISABLE_SAMPLE_DATA conditional compilation constant and disable sample data at runtime.
	...
	public class FoldersSampleDataSource : INotifyPropertyChanged
	{
		...
		public FoldersSampleDataSource()
		{
			try
			{
				Uri resourceUri = new Uri("/MupApps.ControlsNavigation.Sample.WindowsPhone;component/SampleData/FoldersSampleDataSource/FoldersSampleDataSource.xaml", UriKind.RelativeOrAbsolute);
